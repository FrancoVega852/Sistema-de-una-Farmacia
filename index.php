        ...
        <head>
          ...
          <style>
            ...
            * { box-sizing: border-box; margin: 0; padding: 0; }
            ...
            .logo-img { height: 60px; width: auto; animation: pulso 2s infinite; }
            @keyframes pulso { 0%,100% {transform:scale(1);} 50% {transform:scale(1.1);} }
            nav a {
              color: var(--blanco); margin: 0 1rem; text-decoration: none;
              font-weight: bold; transition: 0.3s; font-size: 1.1rem;
            }
            ...
            .hero h2 {
              font-size: 2.8rem; margin-bottom: 1rem; color: var(--verde-oscuro);
            ...
            .botones a {
              ...
              margin:0 0.5rem; text-decoration:none; font-weight:bold;
              font-size:1rem; box-shadow:0 3px 6px rgba(0,0,0,0.2);
              transition: transform 0.3s ease, background 0.3s ease;
            }
            .btn-login { background: var(--acento); color: var(--blanco); }
            .btn-registro { background: var(--verde); color: var(--blanco); }
            .btn-login:hover,.btn-registro:hover { transform: scale(1.1) rotate(-1deg); }
            .seccion {
              max-width:1100px; margin:3rem auto; padding:2rem; background:var(--blanco);
              border-radius:10px; box-shadow:0 2px 8px rgba(0,0,0,0.1);
              animation: fadeIn 1s ease;
            }
            .seccion h2 {
              color:var(--verde-oscuro); margin-bottom:1rem; font-size:1.8rem;
            ...
            .card {
              background:var(--gris); padding:1.5rem; border-radius:8px;
              text-align:center; font-weight:bold; color:var(--verde-oscuro);
              opacity:0; transform:translateY(20px); animation: fadeInUp 0.8s forwards;
            }
            ...
            .card:hover { background:var(--verde); color:var(--blanco); transform:scale(1.08); }
            footer {
              background:var(--verde-oscuro); color:var(--blanco); text-align:center;
              padding:2rem 1rem; margin-top:2rem; animation:slideUp 1s ease;
            }
